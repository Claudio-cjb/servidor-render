...
async def esperar_sala(
    ...
    try:
            ...
            await enviar_a_cliente(
                cliente_profesor,
                {
                    "tipo":
                        "AVISO_TIEMPO_SALA",
                    "mensaje":
                        "La sala se cerrará en un minuto."
                }
            )
        ...
        print(
            "Sala cerrada por falta de conexión:",
            nombre_sala
        )
            ...
            await enviar_a_cliente(
                cliente_profesor,
                {
                    "tipo":
                        "SALA_CERRADA_TIEMPO",
                    "mensaje":
                        "La sala se cerró por falta de conexión."
                }
            )
